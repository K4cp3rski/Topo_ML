...
def train_validate_test_split_data_raw(
    data_raw, train_percent=0.6, validate_percent=0.2, seed=None
):
    np.random.seed(seed)
...
) = train_validate_test_split_data_raw(
    data_raw_V_max_1, train_percent=0.8, validate_percent=0.1, seed=None
)
...
(
    ...
    data_raw_V_max_1_preselected, train_percent=0.8, validate_percent=0.1, seed=None
)
...
(
    ...
    data_raw_V_max_2, train_percent=0.8, validate_percent=0.1, seed=None
)
...
(
    ...
    data_raw_V_max_2_preselected, train_percent=0.8, validate_percent=0.1, seed=None
)
...
dataFrame_train, dataFrame_validate, dataFrame_test = train_validate_test_split(
    dataFrame, train_percent=0.6, validate_percent=0.2, seed=None
)
dataFrame_train.reset_index(inplace=True)
dataFrame_test.reset_index(inplace=True)
dataFrame_validate.reset_index(inplace=True)
